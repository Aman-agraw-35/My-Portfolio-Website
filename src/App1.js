...
// //         <div className="h-[70vh] w-full mt-12 lg:pl-36 pl:0  items-center flex flex-col lg:flex-row ">
// //           <div className="h-auto w-[53%] flex flex-col">
// //           <h1 className=" fontmanual h-auto   text-[7vh] lg:text-[18vh] w-[100%] text-white bef  pb-4 relative pt-24" >Aman Agrawal</h1>
...
// //        <div className="h-[650px] w-full  lg:pr-36 items-center lg:items-stretch   flex flex-col lg:flex-row-reverse   ">
// //           <div className="h-auto lg:w-[60%] w:[90%]  px-24 lg:px-0 ">

// //           <h1 className=" fontmanual about h-auto text-[6vh] lg:text-[18vh] absolute z-10 text-white  lg:w-[50%] w-[90%] pb-4 lg:pt-28">About Me ={`>`} </h1>
// //           {/* <h1 className=" fontmanual1 h-auto text-9xl w-[100%] pb-4 pt-28">About Me ={`>`} </h1> */}
// //           <h1 className="  h-auto text-2xl lg:w-[82%] w-full fontmanual2 text-[#515151] border-l-4 mt-[260px]  border-l-[#515151]   lg:ml-40 pl-10 ">I'm Aman Agrawal, a dedicated student at IIIT Bhopal with a strong
...
// //           </div>
// //           <div className="h-auto w-[40%] hidden lg:block ">
...
// //        <div className="h-[550px]  w-full   lg:pl-36 px-24  flex flex-col   ">
// //           <div className="lg:h-auto h-fit lg:w-[70%] w-full relative ">
// //           <h1 className=" fontmanual h-auto  text-[6vh] lg:text-[18vh] items-center lg:items-stretch w-[100%] absolute  text-white abo pb-4 pt-36">Skills Gained {'=>'}</h1>

// //           {/* <h1 className=" fontmanual1 h-auto text-9xl w-[100%] pb-4 pt-36 abo">Skills Gained {'=>'}</h1> */}
// //        </div>
// //        <div class="h-[230px] text-4xl gap-3 w-[80%] lg:mt-[43vh] mt-[16vh] fontmanual2  grid grid-cols-3 grid-rows-3  text-[#515151]  ">
...
// //           <h1 className=" fontmanual h-auto  text-[7vh] lg:text-[18vh] w-[50%] pb-4 absolute left-[37%] text-white abou "> {'<= '}Education</h1>
...
// //           <h1 className=" fontmanual h-auto  text-[7vh] lg:text-[18vh] w-[70%] ab absolute   text-white  pb-12 pt-24">Projects {'=>'}</h1>
...
// //           <div className="h-[170px] w-[84%]  ">
// //           <h1 className=" fontmanual h-auto  text-[7vh] lg:text-[18vh] lg:w-[60%] w-[30%] pb-4 aaaa   absolute  ml-[65vh] left-[5.1%] text-white "> {'<=  '}Contact Me</h1>
